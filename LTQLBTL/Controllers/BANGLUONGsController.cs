...
namespace LTQLBTL.Controllers
{
    public class BANGLUONGsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaLuong,MaNV,TienLuong")] BANGLUONG bANGLUONG)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaLuong,MaNV,TienLuong")] BANGLUONG bANGLUONG)
        {
            if (ModelState.IsValid)
            {
